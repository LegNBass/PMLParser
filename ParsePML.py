...
from Functions import parsePML
...
if __name__ == "__main__":
	...
	# Display syntax when asked for help
		...
		print '\nSyntax is: python ParsePML.py "HTML Document FilePath" [--runserver]\n'
		print 'The --runserver option starts an http server on port 8000 displaying the formatted output\n'
